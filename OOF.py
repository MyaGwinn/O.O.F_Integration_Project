...
display a simply, "Congrats on trying, at least!"
...
Sources: w3schools, stackoverflow, programiz, PythonCentral, GeeksforGeeks
...
import \
    time  # is there an easier way than repeatedly saying time.sleep()?

# General intro to the program and user's name
print("Hello there, I am O.O.F., an Original Ostentatious Fault-finder.")
...
print(format(challenge1_numbers[0], "36d"), end=" ")  # default is end = "\n"
print(format(challenge1_numbers[1], "27d"), end=" ")  # timer
print("\n", format(number_fake_high, "30d"), end='')
print(format(challenge1_numbers[2], "14d"), end='')
...
print("\n", format(challenge1_numbers[8], "49d"), end='')
print("\n")
...
if answer1 == number_high:
    ...
    print("\nI don't know what I expected, really. Look at the "
          "PLACEMENT. Moving on...")
    points -= 1
...
print("\n.     .     .     .     .")
time.sleep(4)
answer_throw_away = float(
    input("\nThis is the part where you answer it\n\n"))
...
if answer_throw_away != true_answer:
    ...
    points -= 1
    answer2 = float(input(
        "\nIs this the part where I say to round to the first decimal "
        "place? Oops.\n\n"))
    # answer2 = float(input())
    if answer2 != answer_throw_away and answer2 == true_answer:
        ...
        print("\nGave you a second chance, but someone had to throw it "
              "away. The answer's " + str(true_answer) + " by the way.")
        points -= 1
    elif answer2 == answer_throw_away:
...
time.sleep(3)
animal = input(
    ("\n\n" + user_name + ", you must be wondering what the purpose of "
                          "all this is. But before we get into that, tell me, dogs or "
                          "cats?\n"))
...
if animal.lower() in ["cats", "cat"]:
    ...
    print("\nAh, the borkers. The puppers. The fluffy bois. Whatever it "
          "is kids are calling them these days.")
    time.sleep(4)
    ...
    print(
        "\nSurprisingly, I don't take kindly to those who don't play "
        "the game.")
    time.sleep(4)
    points -= 3
else:
...
# this is the only one where the points are special
...
if bug_response.lower() == "a":
    ...
    print("\n\nI like you're attitude, that's my personal favorite "
          "response, extra points for you.")
    time.sleep(4)
    points += 2
else:
...
print("\nMoving onto the next challen-er question, yes, the next "
      "question!")
time.sleep(4)  # Possible point-based transition
print("\nHaha... ha.")
time.sleep(2)

# Animal Challenge 3

correct_animal_list = ["parrot", "alpaca", "fox", "kangaroo", "roach",
                       "elephant"]
correct_animal_list_plural = ["parrots", "alpacas", "foxes", "kangaroos",
                              "roaches", "elephants"]
animal_list = ["Fox", "Alpaca", "Kangaroo", "Elephant", "Roach"]

print("\n\nLet's say you get 5 animals:\n")
time.sleep(3)
...
print("\n\nWhy don't you rank them from the most favored to the most "
      "disgusting:")
time.sleep(3)
# If points < 1, or something, print("Ha, like you have a choice.")
...
def animal_function():  # easier than copy and pasting for "no" response
    ...
    for animal in range(6):  # range goes over from 0 to 5
        ...
        global points  # declared points outside function, must make
        ...
        if count == 1:
            ...
            if user_animal_list[animal] == correct_animal_list[animal] or \
                ...
                if user_animal_list[animal] == "elephant":
                    print("\nHuh. No judgment, I guess. I just prefer "
                          "an alpaca over an " +
                          user_animal_list[animal] + ".")
                elif user_animal_list[
                    animal] in correct_animal_list_plural:
                    print("\nHuh. No judgment, I guess. I just prefer "
            ...
            if user_animal_list[animal] == correct_animal_list[animal] or \
                ...
                time.sleep(1.4)
                print(
                    "\nIf your least favorite animal isn't a roach what's"
                    " wrong with you?")
                time.sleep(3)
                points -= 0.5
...
if sentence_answer.lower() == 'a':
    print(
        "\nInteresting you got that. How long did it take you to count "
        "each letter?")
    time.sleep(4)
    points += 1
...
time.sleep(3)
print(
    "\nIf it takes eight men ten hours to build the wall, how long would"
    " it take four men?")
time.sleep(4)
trivia_number = float(
    ("\n\nI suggest typing a number before your head hurts.\n\n"))

# trivia_number = float(input())
...
if trivia_number == 20:
    ...
    time.sleep(3)
    print("The answer's 0 silly, the eight men already built the wall!")
    time.sleep(3)
    points -= 2
...
print("\n\nB: The rating on Yelp that made sure California's Disneyland"
      " will never surpass Florida's")
print("\n\nC: Knife + Human = Homicide")
print("\n\nD: A family walked in for a good time, left with a $60 mil"
      " lawsuit\n")
